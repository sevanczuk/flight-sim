...
Canonical name: scene_light_add
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_light_add
Revision: 5287
---
...
```
light_id = scene_light_add(scene_id)
```

## Description

scene_light_add is used to create a light object.
