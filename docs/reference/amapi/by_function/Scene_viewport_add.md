...
Canonical name: scene_viewport_add
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_viewport_add
Revision: 5288
---
...
```
viewport_id = scene_viewport_add(scene_id)
```

## Description

scene_viewport_add is used to create a viewport object.
