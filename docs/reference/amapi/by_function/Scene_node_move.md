...
Canonical name: scene_node_move
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_node_move
Revision: 5282
---
...
```
scene_node_move(scene_node_id, x, y, z)
```

## Description

scene_node_move is used translate a scene node within it's scene.
...
| 2 | `x` | Number | Move object on x axis. Can be nil. |
| 3 | `y` | Number | Move object on y axis. Can be nil. |
| 4 | `z` | Number | Move object on z axis. Can be nil. |
