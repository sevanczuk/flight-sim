...
Canonical name: scene_node_rotate
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_node_rotate
Revision: 5284
---
...
```
scene_node_rotate(scene_node_id, x, y, z)
```

## Description

scene_node_rotate is used rotate a scene node within it's scene.
...
| 2 | `x` | Number | Rotate object on x axis. Can be nil. |
| 3 | `y` | Number | Rotate object on y axis. Can be nil. |
| 4 | `z` | Number | Rotate object on z axis. Can be nil. |
