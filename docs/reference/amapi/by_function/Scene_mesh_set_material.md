...
Canonical name: scene_mesh_set_material
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_mesh_set_material
Revision: 5279
---

# Scene mesh set material
...
scene_mesh_set_material is used to set a material to an existing mesh (3d object).
...
|---|----------|------|-------------|
| 1 | `mesh_id` | ID | Mesh id. Can be created by calling scene_mesh_add |
| 2 | `material_id` | ID | Material id. Can be created by calling scene_material_add |
