...
Canonical name: msfs_variable_subscribe
Namespace: Msfs
Source URL: https://wiki.siminnovations.com/index.php?title=Msfs_variable_subscribe
Revision: 5321
---

# Msfs variable subscribe

## Signature

```
msfs_variable_subscribe(variable, unit, callback_function)
```

## Description

msfs_variable_subscribe is used to subscribe on one or more FS2020/FS2024 variables. You can find the available variables for F2020 [here (official)](https://docs.flightsimulator.com/html/Programming_Tools/SimVars/Simulation_Variables.htm) and FS2024 [here (official)](https://docs.flightsimulator.com/msfs2024/html/6_Programming_APIs/SimVars/Simulation_Variables.htm).
...
|---|----------|------|-------------|
| 1 .. n | `variable` | String | Reference to a variable from Flight Simulator 2020/2024. Use prefix 'L:' for LVARS, see example below. |
...
```lua
-- This function will be called when new data is available from MSFS
 ...
 msfs_variable_subscribe("INDICATED ALTITUDE", "Feet", new_altitude_callback)
```
...
-- This function will be called when new data is available from MSFS
 ...
 -- subscribe to variable
 msfs_variable_subscribe("GENERAL ENG RPM:2", "Rpm", new_rpm_callback)
```
...
-- It is also possible to subscribe to multiple variables
 -- Note that the order in which the variables are given to the msfs_variable_subscribe function determines the order in which the variables will enter the callback function
...
msfs_variable_subscribe("B:AS1000_MENU_PUSH_MFD", "INT", new_data)
```
...
-- This function will be called when new data is available from MSFS
 ...
 -- Subscribe Cessna 172 LVAR
 -- Use L: in front of the LVAR name to indicate that it is an LVAR you are using
 msfs_variable_subscribe("L:Eng1_RPM", "RPM", new_rpm_callback)
```
...
-- This function will be called when new data is available from MSFS
 ...
 -- Subscribe 172 LVAR
 -- Use L: in front of the LVAR name to indicate that it is an LVAR you are using
 msfs_variable_subscribe("L:Eng1_RPM", "RPM",
