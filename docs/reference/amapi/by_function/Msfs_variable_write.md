...
Canonical name: msfs_variable_write
Namespace: Msfs
Source URL: https://wiki.siminnovations.com/index.php?title=Msfs_variable_write
Revision: 5218
---
...
|---|----------|------|-------------|
| 1 | `variable` | String | Reference to a variable from Flight Simulator 2020/2024 |
...
msfs_variable_write("GENERAL ENG GENERATOR ACTIVE:1", "Bool", false)
```
