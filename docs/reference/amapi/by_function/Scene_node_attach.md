...
Canonical name: scene_node_attach
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_node_attach
Revision: 5285
---
...
```
scene_node_attach(scene_node_id, attach_object)
```

## Description

scene_node_attach is used attach an existing camera, light or mesh to a scene node.
