...
Canonical name: scene_camera_add
Namespace: Scene
Source URL: https://wiki.siminnovations.com/index.php?title=Scene_camera_add
Revision: 5286
---
...
scene_camera_add is used to create a camera object.
