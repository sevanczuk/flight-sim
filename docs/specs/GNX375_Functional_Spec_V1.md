...
**Status:** Draft (6 of 7 fragments authored)
...
**Overage trend (6 of 7 fragments archived):** A=+22%, B=+11%, C=+26%, D=+22%, E=+82%, F=+12%. Fragment F is the **lowest relative overshoot** in the series — §11's 14 sub-sections were denser but shorter per sub-section than §10 in Fragment E; §12 and §13 efficiently cross-reference rather than re-authoring Fragment C/D/E content. Pattern suggests Fragment G (the final fragment) should target close to its ~300-line D-19 target with minimal relative overage, since its scope (§§14–15 + Appendix A) is highly structured and the Coupling Summary is the main inflation risk.
