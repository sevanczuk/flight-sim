...
| C2.2-G task prompt drafting                | CD drafts `docs/tasks/c22_g_prompt.md` (covers §§14–15 + Appendix A — Persistent State, External I/O, Family Delta; ~300 lines target per D-19; smallest fragment but highest coupling footprint in Coupling Summary) | 🔶 **IN PROGRESS** (Turn 21, 2026-04-24) |
...
| **Pre-C3 work — assembly script**           | CD authors `scripts/assemble_gnx375_spec.py` per D-18 at C2.2-G archive step. Strips YAML/fragment headers/Coupling Summary blocks; concatenates in manifest order; adds aggregate H1. | ⚪ Pending (gated on C2.2-G archive per D-18) |
| **Pre-C3 work — manifest pre-flight**       | CD authors `scripts/verify_gnx375_manifest.py` per D-22: verifies fragments exist, line counts match, section headers continuous, no duplicate sections, Coupling Summary forward-refs resolve. | ⚪ Pending (per D-22; at or before C2.2-G archive) |
| **Pre-C3 work — Review Priority Guide**     | CD prepends P1/P2/P3 table to aggregate spec at C2.2-G archive step per D-22. P1: §§11, 15, 4.9, 7. P2: §§5–6, 8–10, 14, 12, 13. P3: §§1–4, Appendices. | ⚪ Pending (at C2.2-G archive)                 |
