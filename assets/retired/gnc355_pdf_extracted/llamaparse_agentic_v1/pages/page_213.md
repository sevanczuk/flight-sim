...
Upon loading the visual approach, a pop-up informs when vertical guidance is available. If available, the pop-up contains the glidepath angle (GPA) and threshold crossing (TCH).
...
190-02488-01 Rev. C    Pilot’s Guide    3-95
