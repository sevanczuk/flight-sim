...
THIS INSTRUMENT IS ONLY AN OVERLAY. It does not generate the G1000 screen content. It must be used
in conjunction with pop out instrument from Microsoft Flight Simulator. Right Alt + Click on the G1000 
...
if instrument_prop("PLATFORM") == "RASPBERRY_PI" or instrument_prop("PLATFORM") == "ANDROID" or instrument_prop("PLATFORM") == "IPAD" then
    ...
    canv_message = canvas_add(189, 47, 1034, 775, function()
        _rect(0,0,1034,775)
        _fill("blue")
        _txt("THIS FS2020 GPS OVERLAY", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 298)
        _txt("WORKS ON THE DESKTOP ONLY", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 348)
        _txt("BUTTONS AND DIALS STILL WORK", "font:roboto_bold.ttf; size:70; color: white; halign:center;", 517, 398)
        _txt("CLICK HERE TO HIDE THIS MESSAGE", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 548)
    end)
...
if (instrument_prop("PLATFORM") == "WINDOWS" or instrument_prop("PLATFORM") == "MAC" or instrument_prop("PLATFORM") == "LINUX") and not persist_get(pers_msg_read) then
    canv_message = canvas_add(189, 47, 1034, 775, function()
        _rect(0,0,1034,775)
        _fill("blue")
        _txt("THIS IS AN OVERLAY ONLY", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 298)
        _txt("IT REQUIRES THE FLIGHTSIM GPS POP OUT", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 348)
        _txt("SEE OUR WIKI FOR MORE INFORMATION", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 398)
        _txt("CLICK HERE TO HIDE THIS MESSAGE", "font:roboto_bold.ttf; size:60; color: white; halign:center;", 517, 548)
    end)
    butn_hide = button_add(nil, nil, 189, 47, 1034, 775, function()
        visible(canv_message, false)
