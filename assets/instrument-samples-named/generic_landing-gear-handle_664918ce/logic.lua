...
img_unlock = img_add("unlock.png",43,32,50,34, "visible:false")
img_LH = img_add("LH.png",11,94,34,50, "visible:false")
img_NO = img_add("NO.png",51,71,34,50, "visible:false")
img_RH = img_add("RH.png",91,94,34,50, "visible:false")
...
switch_handle = switch_add("handleup.png", "handledown.png", 51, 129, 45, 217, gear_switch)
...
fs2024_variable_subscribe("GEAR CENTER POSITION", "Percent", 
                          ...
                          "GEAR RIGHT POSITION", "Percent", 
                          "GEAR HANDLE POSITION", "Bool", 
                          "ELECTRICAL BUS VOLTAGE:1", "Volts", new_gear_deploy_FSX)