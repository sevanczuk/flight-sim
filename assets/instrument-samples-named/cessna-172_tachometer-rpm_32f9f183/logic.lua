...
tach0_id = running_txt_add_ver(238,174,10,80,30,value_callback,"font:arimo_bold.ttf; size:36px; color: black; halign: right;")
viewport_rect(tach0_id,300,324,80,36)
tach1_id = running_txt_add_ver(235,174,10,50,30,value_callback,"font:arimo_bold.ttf; size:36px; color: white; halign: right;")
viewport_rect(tach1_id,260,324,80,36)
tach2_id = running_txt_add_ver(202,174,10,50,30,value_callback,"font:arimo_bold.ttf; size:36px; color: white; halign: right;")
viewport_rect(tach2_id,227,324,80,36)
tach3_id = running_txt_add_ver(169,174,10,50,30,value_callback,"font:arimo_bold.ttf; size:36px; color: white; halign: right;")
viewport_rect(tach3_id,194,324,80,36)
tach4_id = running_txt_add_ver(136,174,10,50,30,value_callback,"font:arimo_bold.ttf; size:36px; color: white; halign: right;")
...
function PT_rpm(rpm_XPL, rpm_AFL)
    ...
    rotate(img_needle, rpm * (250/3490) - 125)
end

function rpm_fsx(rpma2a, rpmfsx)

    if rpma2a > 0 and rpma2a ~= nil then
        rpm = rpma2a
    else
        rpm = rpmfsx
    end
    ...
    rotate(img_needle, rpm * (250/3500) - 125)

end

function rpm_fs2020(rpm)
...
function flight_time_fs2020(hours)
    
    -- Make default timer global
    gbl_fsx_hours = hours
